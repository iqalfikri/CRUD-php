...
//mengqueri kan data dari database connection.php
//mysqli_query(varible koneksi, sql sintaks yang ingin dijalankan)
$query = mysqli_query($connect, "SELECT * FROM Karyawan"); //add semua data

//mengambil data dari query dan ubah ke array
//mysqli_fetch_all(variable query, konstanta asosiasi)
